...
#[derive(Debug, Clone, PartialEq, Eq, Ord, PartialOrd, Hash, CandidType)]
...
impl Storable for Base64UrlSafeData {
...
impl BoundedStorable for Base64UrlSafeData {
    const MAX_SIZE: u32 = 1024 * 1024 * 10; // 10MB
